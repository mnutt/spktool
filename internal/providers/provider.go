...
func (r *Registry) lookup(name domain.ProviderName) (Plugin, error) {
...
func (r *Registry) RuntimeProvider(name domain.ProviderName) (RuntimeProvider, error) {
	return r.lookup(name)
}

func (r *Registry) BootstrapRenderer(name domain.ProviderName) (BootstrapRenderer, error) {
	return r.lookup(name)
}

func (r *Registry) GrainManager(name domain.ProviderName) (GrainManager, error) {
	return r.lookup(name)
}

func (r *Registry) InstanceNamer(name domain.ProviderName) (InstanceNamer, error) {
	return r.lookup(name)
}
